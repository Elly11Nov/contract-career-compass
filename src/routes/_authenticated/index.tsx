  ...
  head: () => ({
    meta: [
      { title: "Contract Job Finder — Daily Contract Vacancy Dashboard" },
      {
        name: "description",
        content:
          "Daily dashboard of English-language contract, freelance and interim Technical Writer and Business Analyst vacancies across France, Switzerland, Italy, Sweden, Denmark, Finland and Ireland, plus contract-only coverage of Germany, Czechia, Hungary, Poland and Romania.",
      },
        ...
        <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-3 px-4 py-5 lg:px-8">
          <div>
            ...
            <p className="text-surface-header-foreground/70 mt-0.5 text-sm">
              Contract, freelance and interim documentation & analysis roles — France, Switzerland,
              Italy, Sweden, Denmark, Finland, Ireland · contract-only: Germany, Czechia, Hungary,
              Poland, Romania
            </p>
          </div>
